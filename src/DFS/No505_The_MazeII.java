 ...
 */
public class No505_The_MazeII {

    //bfs  time:O(m*n*max(m,n))  space:O(mn)
    public static int shortestDistance1(int[][] maze, int[] start, int[] destination) {
        ...
        while (!q.isEmpty()){
            ...
            for (int[] dir: dirs){
                ...
                if (d[s[0]][s[1]] + count < d[x-dir[0]][y-dir[1]]){
                    d[x-dir[0]][y-dir[1]] = d[s[0]][s[1]] + count;
    ...
    private static void dfs(int[][] maze, int[] start, int[][] d) {
        int[][] dirs = {{0, 1}, {0, -1}, {-1, 0}, {1, 0}};
        for (int[] dir: dirs){
            int x = start[0] + dir[0];
            int y = start[1] + dir[1];
            ...
            if (d[start[0]][start[1]] + count < d[x-dir[0]][y-dir[1]]){
                d[x-dir[0]][y-dir[1]] = d[start[0]][start[1]] + count;
                dfs(maze, new int[]{x-dir[0], y-dir[1]}, d);
            }
        }
    }
    ...
    public static void main(String[] args) {
        ...
        int[] start = {0, 4};
        int[] end = {4, 4};
        int res = shortestDistance1(maze, start, end);
