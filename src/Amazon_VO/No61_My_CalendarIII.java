 ...
 */
public class No61_My_CalendarIII {

    /*
    Time Complexity: O(N^2), where N is the number of events booked. For each new event, we traverse delta in O(N) time. In Python, this is (N^2logN) owing to the extra sort step.
    Space: O(N), the size of delta
     */
