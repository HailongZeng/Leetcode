 ...
 */
//leetcode545
public class No52_Boundary_of_Binary_Tree {
    ...
    public static void leftBoundary(TreeNode node, List<Integer> res){
    ...
    public static void rightBoundary(TreeNode node, List<Integer> res){
        if (node == null || (node.left == null && node.right == null)) return;
    ...
    public static void leaves(TreeNode node, List<Integer> res){
        if (node == null) return;
